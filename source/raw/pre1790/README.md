...
- `manual_corrections.csv` — Manual corrections for records identified during quality review, created by reviewing automated cleaning output against original documents
...
Covers four certificate types: loan office, state liquidated debt, Pierce, and marine. Pennsylvania has two separate ledgers (Stelle and Story).
