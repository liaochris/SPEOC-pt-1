...
- `standardize_geography.py` — Imports all state XLSX files via `cd_import_metadata.csv` config, standardizes town/county/state names
...
- `source/raw/post1790_cd/docs/cd_import_metadata.csv` — Import configuration
- `source/raw/post1790_cd/corrections/` — Manual correction files (town_fix, company_names_fix, occ_fix)
